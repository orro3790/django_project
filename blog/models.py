...
class Post(models.Model):
    ...
    snapshot_1 = models.ImageField(blank=False, default='', upload_to='food_blog_snapshots')
    ...
    snapshot_2 = models.ImageField(blank=False, default='', upload_to='food_blog_snapshots')
    ...
    snapshot_3 = models.ImageField(blank=False, default='', upload_to='food_blog_snapshots')
    ...
    snapshot_4 = models.ImageField(blank=False, default='', upload_to='food_blog_snapshots')
    ...
    snapshot_5 = models.ImageField(blank=False, default='', upload_to='food_blog_snapshots')
